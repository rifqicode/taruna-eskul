                ...
                <div class="container">
                  <form method="post">
                   <table class="table">
                     <tr>
                       <td> Nama </td>
                       <td><input type="text" name="nama" value="" placeholder="<?php echo $hasilsiswa['nama']; ?>" required></td>
                     </tr>
                     <tr>
                       <td> Kelas </td>
                     ...
                     <tr>
                       <td> Email </td>
                       <td><input type="text" name="email" value="" placeholder="<?php echo $hasilsiswa['email']; ?> " required></td>
                     </tr>
                     <tr>
                   ...
                   <?php
                     ...
                     if (isset($_POST['submit'])) {
                       ...
                       if (settings($nis_siswa , $nama , $kelas , $jurusan , $email)) {
                         ?> <a href="settings.php"> Edit Sukses </a> <?php
                       } else {
                         echo "Edit gagal";
                       }
                     }
